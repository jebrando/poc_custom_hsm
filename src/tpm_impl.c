...
TPM_HANDLE tpm_openssl_create(void)
{
    TPM_INFO* result;
...
void tpm_openssl_destroy(TPM_HANDLE handle)
{
    if (handle != NULL)
    {
...
int tpm_openssl_retrieve_ek(TPM_HANDLE handle, unsigned char* key_value, size_t length)
{
    int result;
...
int tpm_openssl_retrieve_srk(TPM_HANDLE handle, unsigned char* key_value, size_t length)
{
    int result;
    if (handle == NULL || key_value == NULL || length == 0)
    {
...
int tpm_openssl_insert_key(TPM_HANDLE handle, const unsigned char* key_value, size_t length)
{
    int result;
    if (handle == NULL || key_value == NULL || length == 0)
    {
...
int tpm_openssl_hash_data(TPM_HANDLE handle, const unsigned char* data, size_t length)
{
    int result;
...
const char* tpm_openssl_get_last_error(TPM_HANDLE handle)
{
    const char* result;
    if (handle == NULL)
    {
