...
X509_HANDLE x509_impl_create(void)
{
    X509_INFO* result;
...
void x509_impl_destroy(X509_HANDLE handle)
{
    if (handle != NULL)
    {
        free(handle);
...
const char* x509_impl_retrieve_cert(X509_HANDLE handle)
{
    const char* result;
    if (handle == NULL)
    {
...
const char* x509_impl_retrieve_key_alias(X509_HANDLE handle)
{
    const char* result;
    if (handle == NULL)
    {
...
const char* x509_impl_cert_common_name(X509_HANDLE handle)
{
    const char* result;
    if (handle == NULL)
    {
...
const char* x509_impl_get_last_error(X509_HANDLE handle)
{
    const char* result;
    if (handle == NULL)
    {
